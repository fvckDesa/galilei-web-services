...
use crate::schemas::{AppService, AppStatus, EnvVar, Volume};
...
pub async fn reconcile_app(
  ...
  reconcile_deploy(&name, &app, secret_name, volume, client.clone(), &params).await?;
...
async fn reconcile_deploy(
  ...
  if let Some(secret_name) = secret_name {
    let deploy = generate_deploy(name, app, secret_name, volume);
