...
use crate::schemas::{AppService, AppStatus, EnvVar};
...
pub async fn reconcile_app(app: AppService, envs: Vec<&EnvVar>, client: Client) -> Result<()> {
  ...
  reconcile_deploy(&name, &app, secret_name, client.clone(), &params).await?;
 ...
 */
fn generate_deploy(name: &str, app: &AppService, secret_name: String) -> Deployment {
